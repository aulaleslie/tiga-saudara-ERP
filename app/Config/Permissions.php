...
return [
    ...
    'Transfer Stok' => [
        ...
        'stockTransfers.dispatch.create' => 'Buat Pengiriman',
        'stockTransfers.dispatch.approval' => 'Persetujuan Pengiriman',
        'stockTransfers.receive' => 'Terima',
        'stockTransfers.receive.create' => 'Buat Penerimaan',
        'stockTransfers.receive.approval' => 'Persetujuan Penerimaan',
