...
class AgedPayablesReportExport implements FromArray, WithHeadings, WithEvents, WithColumnFormatting
{
    private Builder $query;
    private AgedPayablesReportFilterData $filterData;
    private bool $isCsv;

    public function __construct(Builder $query, AgedPayablesReportFilterData $filterData, bool $isCsv = false)
    {
        $this->query = $query;
    ...
    public function array(): array
    {
        ...
        foreach ($queryResults as $row) {
            $mapped = \App\Services\Reports\AgedPayablesReportQueryService::mapRows($row);
