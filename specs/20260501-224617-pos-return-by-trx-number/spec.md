...
- **FR-019**: The system MUST allow POS returns to be edited or deleted only before approval. Pending POS returns MAY be approved or rejected by authorized users. After approval and before receiving, users MUST use an audited archive/cancel reversal path instead of direct edit/delete/reject actions, and receiving MUST permanently block direct edit/delete/reject/archive/cancel actions.
