<div x-data="{ showDrawer: false, isApplying: false }" x-init="$watch('showDrawer', value => { if(!value && !isApplying) { $wire.cancelFilters(); } isApplying = false; })">
    ...
    @if($filterTriggered && $paginator && $paginator->total() > 0)
        <div class="row mb-3">
            <div class="col-md-4">
                <div class="card bg-light border-0 shadow-sm">
                    <div class="card-body py-2">
                        <div class="text-muted small fw-bold text-uppercase mb-1">Total Produk</div>
                        <div class="fs-4 fw-bold">{{ number_format($paginator->total(), 0, ',', '.') }}</div>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
        ...
        <table class="table table-hover table-bordered mb-0" style="font-size: 0.8rem; min-width: 1000px;">
            <thead class="table-light">
                <tr>
                    ...
                    <th style="white-space:nowrap">No. Referensi</th>
                    ...
                    <th class="text-end" style="white-space:nowrap">Nilai Masuk</th>
                    <th class="text-end" style="white-space:nowrap">Nilai Keluar</th>
                    <th class="text-end" style="white-space:nowrap">Harga Rata-rata</th>
                    <th class="text-end" style="white-space:nowrap">Nilai</th>
                </tr>
            </thead>
