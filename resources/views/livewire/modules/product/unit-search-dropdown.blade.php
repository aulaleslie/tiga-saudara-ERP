...
<div class="d-flex" style="{{ $width ? 'min-width: ' . $width . ';' : '' }}">
    <div class="flex-grow-1 position-relative" wire:click.away="closeDropdown">
        ...
        @if($open)
            <div class="dropdown-menu w-100 shadow show p-2"
                 style="position: absolute; z-index: 1050; max-height: 300px; overflow-y: auto; top: 100%; left: 0; right: 0; {{ $width ? 'min-width: ' . $width . ';' : '' }}">
                <input
                    type="text"
