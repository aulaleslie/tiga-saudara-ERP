                ...
                <div class="col-md-6">
                    ...
                    @if($session->status !== \App\Models\PosSession::STATUS_CLOSED)
                        <form wire:submit.prevent="closeSession" class="mb-0">
                            ...
                            <div class="form-group mb-2">
                                <label class="font-weight-bold">Perkiraan Kas (dihitung otomatis)</label>
                                <input type="text" value="{{ $expectedCash ? number_format($expectedCash, 2, ',', '.') : '-' }}" class="form-control" readonly disabled>
                            </div>
                            <div class="form-group mb-2">
