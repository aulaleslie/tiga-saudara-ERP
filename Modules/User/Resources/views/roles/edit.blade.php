                                                ...
                                                @foreach ($perms as $perm => $permData)
                                                    <div class="custom-control custom-switch mb-2">
                                                        @php
                                                            ...
                                                            $checked = is_array($permData) ? $permData['checked'] : false;
                                                        @endphp
                                                        <input type="checkbox" class="custom-control-input group-member" id="{{ $inputId }}" name="permissions[]" value="{{ $perm }}" {{ $checked ? 'checked' : '' }}>
