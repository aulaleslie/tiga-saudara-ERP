    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <p class="font-italic">Ganti Informasi Akun & password di sini...</p>
            </div>
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update') }}" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Perbaharui Profile <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.update.password') }}" method="POST">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary">Perbaharui Password <i class="bi bi-check"></i></button>
                            </div>
                        </form>
                    </div>
                </div>
