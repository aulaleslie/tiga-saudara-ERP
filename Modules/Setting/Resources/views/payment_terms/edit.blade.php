                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" required
                                               value="{{ $payment_term->name }}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="longevity">Tempo (hari) <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control" name="longevity" step="0.01" value="{{ $payment_term->longevity }}" required>
                                    </div>
                                </div>
                                <div class="col-lg-12 d-flex justify-content-end">
                                    <div class="form-group">
                                        <a href="{{ route('payment-terms.index') }}" class="btn btn-secondary mr-2">
                                            Kembali
                                        </a>
