...
@section('content')
    <div class="container-fluid">
        ...
        <form id="payment-term-edit-form" action="{{ route('payment-terms.update', $payment_term) }}" method="POST">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-12 d-flex justify-content-end">
                                    <div class="form-group">
                                        ...
                                        <x-button label="Simpan" icon="bi-check" processing-text="Memproses…" />
                                    </div>
                                </div>
...
@push('page_scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            initFormSubmissionLock('payment-term-edit-form', {
