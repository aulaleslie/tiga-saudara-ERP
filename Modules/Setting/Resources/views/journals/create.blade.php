    ...
    <div class="container">
        ...
        <form action="{{ route('journals.store') }}" method="POST" id="journalForm">
            ...
            <table class="table table-bordered" id="itemsTable">
                ...
                <tr>
                    <td>
                        <select name="items[0][chart_of_account_id]" id="items_0_chart_of_account_id" class="form-control" required>
                    ...
                    <td>
                        <input type="number" step="0.01" name="items[0][amount_debit]" id="items_0_amount_debit" class="form-control" value="{{ old('items.0.amount_debit') }}">
                    </td>
                    <td>
                        <input type="number" step="0.01" name="items[0][amount_credit]" id="items_0_amount_credit" class="form-control" value="{{ old('items.0.amount_credit') }}">
                    </td>
                    <td>
