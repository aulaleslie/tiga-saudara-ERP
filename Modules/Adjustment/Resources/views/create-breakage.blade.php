                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('adjustments.storeBreakage') }}" method="POST">
                            ...
                            <livewire:adjustment.breakage-product-table :type="'sub'"/>
                            <div class="form-group">
                            ...
                            <div class="mt-3">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    Create Breakage <i class="bi bi-check"></i>
                                </button>
                            </div>
                        </form>
                    </div>
