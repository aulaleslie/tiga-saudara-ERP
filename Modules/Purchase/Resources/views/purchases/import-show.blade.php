...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <a href="{{ route('purchases.imports.index') }}" class="btn btn-secondary me-2">
        ...
        <div class="card">
            ...
            <div class="card-body">
                {{-- Filter Form --}}
                <form action="{{ route('purchases.imports.show', $batch) }}" method="GET" class="mb-3">
                    <div class="row g-2">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-4">
                            <input type="text" name="search" class="form-control" placeholder="Cari Error, Supplier, Produk..." value="{{ request('search') }}">
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            @if(request()->hasAny(['status', 'search']))
                                <a href="{{ route('purchases.imports.show', $batch) }}" class="btn btn-outline-secondary w-100">Reset</a>
                            @endif
                        </div>
                    </div>
                </form>
