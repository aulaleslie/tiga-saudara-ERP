...
@section('title', 'Buat Pembelian (Alpine.js)')

@section('breadcrumb')
    <ol class="breadcrumb border-0 m-0">
        <li class="breadcrumb-item"><a href="{{ route('home') }}">Beranda</a></li>
        <li class="breadcrumb-item"><a href="{{ route('purchases.index') }}">Pembelian</a></li>
        <li class="breadcrumb-item active">Tambah (Alpine.js)</li>
    </ol>
@endsection
                        ...
                        >
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="reference" x-model="form.reference" readonly>
                                </div>
