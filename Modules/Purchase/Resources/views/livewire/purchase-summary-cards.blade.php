<div class="row mb-4">
    <!-- Belum Dibayar -->
    <div class="col-md-4">
        <div class="card border-0 border-start border-primary border-4 shadow-sm h-100" style="cursor: pointer;" wire:click="$dispatch('purchase-filter', { type: 'unpaid' })">
            <div class="card-body">
    ...
    <!-- Telat Bayar -->
    <div class="col-md-4">
        <div class="card border-0 border-start border-danger border-4 shadow-sm h-100" style="cursor: pointer;" wire:click="$dispatch('purchase-filter', { type: 'overdue' })">
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card border-0 border-start border-success border-4 shadow-sm h-100" style="cursor: pointer;" wire:click="$dispatch('purchase-filter', { type: 'paid' })">
            <div class="card-body">
