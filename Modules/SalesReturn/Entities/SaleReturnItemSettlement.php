...
class SaleReturnItemSettlement extends BaseModel
{
    protected $table = 'sale_return_item_settlements';
    protected $guarded = [];
    ...
    {
        return $this->belongsTo(SaleReturnDetail::class, 'sale_return_detail_id');
    }
    ...
    public function targetSale(): BelongsTo
    {
        return $this->belongsTo(Sale::class, 'target_sale_id');
    }
