...
Route::group(['middleware' => ['auth', 'role.setting']], function () {
    ...
    Route::get('/products/{product_id}/input-serial-numbers', [ProductController::class, 'inputSerialNumbers'])->name('products.inputSerialNumbers');
    Route::post('products/{product_id}/input-serial-numbers', [ProductController::class, 'storeSerialNumbers'])->name('products.storeSerialNumbers');
    //Product
