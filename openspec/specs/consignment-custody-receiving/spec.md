...
## Purpose
Establish a Phase 1 consignment custody receiving workflow for inbound stock-managed products with deterministic lifecycle safety, location governance, concurrency protection, and audit trails.
