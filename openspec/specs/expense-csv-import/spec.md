# expense-csv-import Specification

## Purpose
Import approved expenses from CSV with grouping by source document number, category/supplier fallback, and row-based counting.
