# stock-transfer-forward-dispatch Specification

## Purpose
Authoritative forward dispatch preparation, permission-aware physical observations, exact canonical request/count comparison, atomic origin inventory deduction, exclusive in-transit custody activation, and idempotent approval for workflow version 2 transfers.
