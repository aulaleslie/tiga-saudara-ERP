# customer-name-uniqueness Specification

## Purpose
Prevent duplicate customer records by enforcing case-insensitive, whitespace-trimmed uniqueness on `customer_name` and `contact_name` across every customer create and update entry point.
