# external-document-number-governance Specification

## Purpose
TBD - created by archiving change scope-external-document-number-uniqueness. Update Purpose after archive.
## Requirements
