# product-bundle-table-editor Specification

## Purpose

This specification defines the requirements for the bundle item editor table, ensuring that item quantities, informational prices, and row identities are correctly managed and persisted during bundle creation and editing.
