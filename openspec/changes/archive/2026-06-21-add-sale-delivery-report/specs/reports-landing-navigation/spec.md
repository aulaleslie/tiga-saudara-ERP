...
- **AND** Penjualan shows Daftar Penjualan, Penjualan Per Customer, Piutang pelanggan, Usia piutang, and Pengiriman penjualan (gated by `saleReports.access`)
- **AND** Penjualan shows Penjualan Global (gated by `saleReports.global.access`)
