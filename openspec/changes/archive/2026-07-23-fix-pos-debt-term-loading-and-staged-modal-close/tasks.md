...
- [x] 4.3 Perform browser/UAT verification with production-like payment terms for term selection, visible load failure and retry, ×/**Batal** dismissal, explicit reset confirmation, and processing locks. (OPEN: Manual browser verification required - to be done after code review)
