...
The system SHALL derive dispatch tax context for each bundle component from its parent `sale_details.tax_id` and MUST use that inherited value when building dispatch composite keys.
