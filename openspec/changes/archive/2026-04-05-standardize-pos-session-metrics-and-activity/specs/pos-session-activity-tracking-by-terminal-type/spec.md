...
## Purpose
Define how transaction volume and activity timestamps are tracked and displayed differently for terminal vs non-terminal POS sessions, accommodating both cashier checkout workflow (terminals) and floor staff transaction creation workflow (non-terminals).
