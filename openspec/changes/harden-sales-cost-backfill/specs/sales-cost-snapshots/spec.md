...
The system SHALL provide a backfill command that fills sale detail cost snapshots by replaying historical product purchase, purchase return, and sale events in deterministic effective-date order.
