...
class ProductListDisplayTest extends TestCase
{
    ...
    public function test_product_list_shows_link_and_stock_pills()
    {
        ...
        $this->assertStringContainsString('Total Stok: <span class="font-weight-bold">0', $productCodeHtml);
        $this->assertStringContainsString('Stok Baik: <span class="font-weight-bold text-success">0', $productCodeHtml);
        $this->assertStringContainsString('Stok Rusak: <span class="font-weight-bold text-danger">0', $productCodeHtml);
        ...
        $this->assertStringContainsString('Total Stok: <span class="font-weight-bold">12', $productCodeHtml);
        $this->assertStringContainsString('Stok Baik: <span class="font-weight-bold text-success">10', $productCodeHtml);
        $this->assertStringContainsString('Stok Rusak: <span class="font-weight-bold text-danger">2', $productCodeHtml);
    }
}
