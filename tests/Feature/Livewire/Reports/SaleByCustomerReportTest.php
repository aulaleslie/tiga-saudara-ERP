...
use App\Livewire\Reports\SaleByCustomerReport;
...
class SaleByCustomerReportTest extends TestCase
{
    ...
    public function test_discounted_single_line_invoice_expands_to_product_diskon_pajak()
    {
        ...
        $component = Livewire::actingAs($this->user)
            ->test(SaleByCustomerReport::class)
        ...
        $mappedRows = \App\Services\Reports\SaleByCustomerReportQueryService::mapRows($detail, 0, true);
