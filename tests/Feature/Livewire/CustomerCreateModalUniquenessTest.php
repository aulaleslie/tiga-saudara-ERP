...
use App\Livewire\Customer\CreateModal;
use App\Models\User;
...
class CustomerCreateModalUniquenessTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_create_modal_rejects_duplicate_customer_name(): void
    {
    ...
    public function test_create_modal_accepts_distinct_customer_names(): void
    {
        // Create first customer
    ...
    public function test_create_modal_rejects_duplicate_customer_name_case_insensitive(): void
    {
        // Create first customer
        Customer::create([
            'setting_id' => $this->setting->id,
